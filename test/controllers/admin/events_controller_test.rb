...
class Admin::EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post admin_events_url, params: { admin_event: { day: @admin_event.day, descrption: @admin_event.descrption, name: @admin_event.name, travel_id: @admin_event.travel_id } }
    end
  ...
  test "should update admin_event" do
    patch admin_event_url(@admin_event), params: { admin_event: { day: @admin_event.day, descrption: @admin_event.descrption, name: @admin_event.name, travel_id: @admin_event.travel_id } }
