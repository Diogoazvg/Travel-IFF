...
class Admin::PeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_person" do
    assert_difference('Admin::Person.count') do
      post admin_people_url, params: { admin_person: { address: @admin_person.address, birth: @admin_person.birth, cpf: @admin_person.cpf, identity: @admin_person.identity, name: @admin_person.name, phone: @admin_person.phone } }
    end
  ...
  test "should update admin_person" do
    patch admin_person_url(@admin_person), params: { admin_person: { address: @admin_person.address, birth: @admin_person.birth, cpf: @admin_person.cpf, identity: @admin_person.identity, name: @admin_person.name, phone: @admin_person.phone } }
