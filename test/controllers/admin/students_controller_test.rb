...
class Admin::StudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_student" do
    assert_difference('Admin::Student.count') do
      post admin_students_url, params: { admin_student: { person_id: @admin_student.person_id, registration_content_type: @admin_student.registration_content_type, registration_file_name: @admin_student.registration_file_name, registration_file_size: @admin_student.registration_file_size, registration_updated_at: @admin_student.registration_updated_at } }
    end
  ...
  test "should update admin_student" do
    patch admin_student_url(@admin_student), params: { admin_student: { person_id: @admin_student.person_id, registration_content_type: @admin_student.registration_content_type, registration_file_name: @admin_student.registration_file_name, registration_file_size: @admin_student.registration_file_size, registration_updated_at: @admin_student.registration_updated_at } }
